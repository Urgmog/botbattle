...
client.login("NDk0NTAwODk5MDM3NzczODQy.Do7Dug.6_kk9FY2g09ja4outpAGv35ayBc");
...
client.on("ready", () => {
    ...
    client.user.setGame("Projet Battle Royale");
...
client.on('message', async message => { 
    ...
    if(message.content === prefix + "help") {
      ...
      .setFooter("Menu d'aide - Projet Battle Royale")
      .setTimestamp()
    ...
    if(message.content === prefix + "mod") {
      ...
      .setFooter("Commande modération - Projet Battle Royale")
      .setTimestamp()
